  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        slideUp:     { "0%": { opacity: "0", transform: "translateY(14px) scale(0.98)" }, "100%": { opacity: "1", transform: "translateY(0) scale(1)" } },
        slideDown:   { "0%": { opacity: "0", transform: "translateY(-10px) scale(0.98)" }, "100%": { opacity: "1", transform: "translateY(0) scale(1)" } },
        glowPulse:   { "0%,100%": { boxShadow: "0 0 14px rgb(var(--rift-glow) / 0.18)" }, "50%": { boxShadow: "0 0 34px rgb(var(--rift-glow) / 0.44)" } },
        ringBreathe: { "0%,100%": { opacity: "0.25", transform: "scale(1)" }, "50%": { opacity: "0.60", transform: "scale(1.05)" } },
        float:       { "0%,100%": { transform: "translateY(0px)" }, "50%": { transform: "translateY(-7px)" } },
        radar:       { "0%": { transform: "scale(0.5)", opacity: "0.7" }, "100%": { transform: "scale(2.5)", opacity: "0" } },
      },
      boxShadow: {

    ...
    <>
      ...
      >
        ...
        <button
          ...
          title="Contact us"
          className="w-6 h-6 flex items-center justify-center rounded-full transition-all duration-150 flex-shrink-0"
          style={{
          ...
          onMouseEnter={(e) => {
            ...
            b.style.boxShadow = "0 0 0 1px rgb(var(--rift-accent) / 0.3), 0 0 10px rgb(var(--rift-glow) / 0.2)";
          }}
          onMouseLeave={(e) => {
            const b = e.currentTarget as HTMLButtonElement;

  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        conicSpin:  {
          "0%":   { "--conic-angle": "0deg" } as Record<string, string>,
          "100%": { "--conic-angle": "360deg" } as Record<string, string>,
        },
        conicSpinR: {
          "0%":   { "--conic-angle": "360deg" } as Record<string, string>,
          "100%": { "--conic-angle": "0deg" } as Record<string, string>,
        },
      },
      boxShadow: {
